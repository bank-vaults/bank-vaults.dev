...
[the vault-operator repository](https://github.com/bank-vaults/vault-operator/blob/main/deploy/examples/). The following examples use only this [vanilla CR](https://github.com/bank-vaults/vault-operator/blob/v{{< param "latest_vault_operator" >}}/deploy/examples/cr.yaml)
